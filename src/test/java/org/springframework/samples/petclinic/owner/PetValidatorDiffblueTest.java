...
public class PetValidatorDiffblueTest {
  ...
  public void testValidate() {
    ...
    assertEquals("org.springframework.validation.BindException:" + " org.springframework.validation.BindException:"
        ...
        + ": 3 errors\n" + "Field error in object 'objectName' on field 'name':"
        + " rejected value [null]; codes [required.objectName"
        ...
        + ".LocalDate,required]; arguments []; default message" + " [required]", bindException.getMessage());
