...
public class VisitControllerDiffblueTest {
  ...
  public void testProcessNewVisitForm() throws Exception {
    ...
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders
        .post("/owners/*/pets/{petId}/visits/new", 123456789).param("date", "2000-01-01")
        .param("description", "a value for description");

    // Act
    ResultActions actualPerformResult = this.mockMvc
        .perform(paramResult.param("petId", String.join("", "123456", "789")));
